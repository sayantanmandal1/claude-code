...
- `MACRO.PACKAGE_URL` — npm package name (e.g., `"@sayantanmandal/claude-code"`)
...
const MACRO_OBJ = {
  VERSION: version,
  PACKAGE_URL: '@sayantanmandal/claude-code',
  ISSUES_EXPLAINER: 'report issues at https://github.com/sayantanmandal/claude-code/issues',
}
